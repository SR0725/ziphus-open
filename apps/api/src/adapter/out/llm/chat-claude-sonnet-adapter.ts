...
const chatPricePerInputToken = 3 / 1000000;
const chatPricePerOutputToken = 15 / 1000000;

const ChatClaudeSonnetAdapter: LLMApiUsePort = async (
  prompt,
  chatHistories
) => {
...
export default ChatClaudeSonnetAdapter;
